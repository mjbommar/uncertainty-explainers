...
| FineWeb general web | 92.42% | 0.72 |
| FineWeb educational web | 92.49% | 0.65 |
| BookCorpusOpen (modern books) | 93.04% | 0.43 |
| CNN/DailyMail (news) | 93.23% | 0.25 |
| ELI5 (lay explanation) | 96.22% | 0.35 |
| **US federal bills** | **95.56%** | **16.72** |
| **California bills** | **96.16%** | **24.34** |
...
**R1. Do not use an unapproved word or phrase.** Each entry carries a
replacement and a grade. The list is seeded from plainlanguage.gov and
extended with the smothered verbs, doublets, sentence stretchers, and the
"times smaller" family from *The Analyst's Style Manual*[^asm]
(`source: analysts-style-manual` in `curated.yaml`):
...
- 19 phrases: *and/or*, *any and all*, *at this time*, *by virtue of*, *for the purpose of*, *in excess of*, *in lieu of*, *in regard to*, *in the absence of*, *it is required that*, *null and void*, *pertaining to*, *prior to*, *times fewer*, *times less*, *times smaller*, *with regard to*, *with respect to*, *with the exception of*

**`idea`** — shown only with `--advisory`.

- 43 words: *additional*, *allocate*, *approximately*, *assist*, *attempt*, *cognizant*, *commenced*, *constitutes*, *convene*, *correspondence*, *designate*, *discontinue*, *enumerate*, *equitable*, *expiration*, *feasible*, *finalize*, *implement*, *initiate*, *inquire*, *liaison*, *methodology*, *notify*, *obtain*, *participate*, *preclude*, *prioritize*, *proficiency*, *promulgated*, *promulgation*, *purchase*, *regarding*, *relocate*, *requirement*, *reside*, *residence*, *retain*, *solicit*, *submit*, *subsequent*, *sufficient*, *terminate*, *transmit*
- 35 phrases: *a majority of*, *a number of*, *as to whether*, *come to the conclusion*, *conduct a review*, *conduct an analysis*, *conduct an inspection*, *conduct an investigation*, *duties and responsibilities*, *each and every*, *first and foremost*, *full and complete*, *has the ability to*, *have a tendency to*, *importance and significance*, *in conjunction with*, *in order to*, *in terms of*, *in the near future*, *is able to*, *it is necessary that*, *make a recommendation*, *make an announcement*, *make an assessment*, *on a daily basis*, *on a regular basis*, *perform an analysis*, *provide a description of*, *provide assistance*, *reach a decision*, *reach an agreement*, *take into account*, *the fact that*, *the majority of*, *there is a need for*

Tiers: **20,794** core forms, **45,330** open, **67,632** OpenGloss-recognized, **38** sensitive; **70** word and **75** phrase substitutions (lexicon v1, built 2026-09-23).
<!-- /sbe:generated -->
...
expand it at its first use, and give it a glossary entry. The intelligence
style manuals, written for long reports, add three rules the checker does
not enforce: **repeat the full name every so often** in a long work,
without re-specifying the abbreviation, so a reader who opened at chapter
nine is not sent to the glossary; if the first reference is plural, the
abbreviation is plural too ("reentry vehicles (RVs)"); and never hang the
abbreviation off a possessive — not "the Treaty's (NPT) ban" but "the ban
under the Treaty (NPT)."[^asm] The checker accepts
...
A non-English word is the same case with one extra convention: if it has
been naturalized (*debacle*, *attaché*, *modus operandi*), write it as
English; if it has not, italicize it and follow it with a translation in
parentheses — a free explanation where that helps more than a literal one
("*enosis* (union with Greece)"). A foreign title may be translated or
explained; for a newspaper, "official organ of the ruling party" often
tells the reader more than the translated name would.[^asm]
...
[^asm]: *The Analyst's Style Manual*, Mercyhurst College Institute for
Intelligence Studies Press, 2008 (1st ed., compiled and edited by Bill
Welch; ISBN 978-0-9773881-1-0), built from the CIA *Style Manual & Writers
Guide for Intelligence Publications* and the US Army *Military Writing
Reference Book*. Free PDF (CC BY-NC) at
<https://ncirc.bja.ojp.gov/sites/g/files/xyckuh326/files/media/document/analysts_style_manual.pdf>.
Abbreviations §4.2–4.8; italics and foreign words §5.4–5.9; numbers
§2.21–2.26 (percent vs. percentage point, "times smaller"); Rules 4–5
(short conventional words, smothered verbs, doublets, stretchers). The
register-level rules — bottom line up front, paragraph shape, active
voice — are the `analytic-brief` style profile.
